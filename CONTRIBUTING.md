...
_See also: [Contributor Covenant Code of Conduct](https://github.com/FlutterGen/flutter_assets_gen/blob/main/CODE_OF_CONDUCT.md)_
...
```sh
$ dart packages/command/bin/flutter_assets_gen_command.dart --config example/pubspec.yaml
```
...
- `git pull-request` (if you are using [Hub](http://github.com/github/hub/)) or
  go to `https://github.com/FlutterGen/flutter_assets_gen` and click the
