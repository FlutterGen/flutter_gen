...
class Colour extends Color {
  const Colour(super.value);

  /// Color: #000000
  static const black = Colour(0xFF000000);

  /// Color: #4D000000
  static const black30 = Colour(0x4D000000);

  /// Color: #66000000
  static const black40 = Colour(0x66000000);

  /// Color: #80000000
  static const black50 = Colour(0x80000000);
  ...
  /// Color: #979797
  static const gray410 = Colour(0xFF979797);

  /// Color: #EEEEEE
  static const gray70 = Colour(0xFFEEEEEE);
