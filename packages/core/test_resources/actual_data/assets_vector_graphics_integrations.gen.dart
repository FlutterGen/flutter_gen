...
class $AssetsImagesIconsGen {
  ...
  /// File path: assets/images/icons/fuchsia.vec
  SvgVecGenImage get fuchsia =>
      const SvgVecGenImage('assets/images/icons/fuchsia.vec');

  /// List of all assets
  List<SvgVecGenImage> get values => [dartTestSvg, fuchsia];
}
