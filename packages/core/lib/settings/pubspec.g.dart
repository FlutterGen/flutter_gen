...
FlutterGen _$FlutterGenFromJson(Map json) => $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = FlutterGen(
          ...
          lineLength1: $checkedConvert('line_length', (v) => v as int),
          lineLength0: $checkedConvert('lineLength', (v) => v as int),
          nullSafety: $checkedConvert('null_safety', (v) => v as bool),
...
FlutterGenIntegrations _$FlutterGenIntegrationsFromJson(Map json) =>
    $checkedCreate(
      ...
      ($checkedConvert) {
        $checkKeys(
          json,
          requiredKeys: const ['flutter_svg', 'flare_flutter'],
        );
